 ...
 * @returns {String}
 */
function getStatus(status, name, db) {
    let statusExt = ''
    switch (status) {
        case 'offline':
        case db.obtener(name + '.UsageCpu') == "null":
        statusExt = '🔴 | OFFLINE'
        break;
        case 'online':
        case 'dnd':
